/* SpaceNet 4238 — scrub fake TREASURY 3M; paint after PayPal credit. Guest absent. */
(function (g) {
  "use strict";
  if (g.__SN_MONEY_4238) return;
  g.__SN_MONEY_4238 = true;
  ...
  function user() {
    try {
      if (g.SNAuth && typeof SNAuth.user === "function") {
        var au = SNAuth.user();
        if (au && au.email) return au;
      }
    } catch (e0) {}
    try {
