/* SpaceNet SW 4269 — JS sizes the canvas. Tree lock. */
var CACHE = "sn-shell-4269";
var VER = "4269";
var SHELL = ["/", "/index.html", "/js/spacenet/app.js?v=4269", "/js/spacenet/auth.js?v=4269", "/js/vendor/leaflet.js?v=4127", "/js/vendor/leaflet.css?v=4127", "/icon-192.png", "/manifest.webmanifest"];
...
self.addEventListener("fetch", function (e) {
  ...
  if (isOverlay(url.pathname)) {
    e.respondWith(new Response("/* TREE LOCK 4269: overlay blocked */", { headers: { "Content-Type": "application/javascript" }, status: 200 }));
    return;
  }
