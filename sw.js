/* SpaceNet SW 4211 — network-first shell. Never cache a stub. */
var CACHE = "sn-shell-4211";
...
function withShell(html) {
  ...
  inject('spacenet/app.js?v=4204"></script>', "/js/spacenet/earth-4204.js?v=4211");
  inject('spacenet/app.js?v=4160"></script>', "/js/spacenet/earth-4204.js?v=4211");
  inject('money-keep-4210.js?v=4210"></script>', "/js/spacenet/land-4162.js?v=4211");
  inject('verify-sn-4208.js?v=4208"></script>', "/js/spacenet/land-4162.js?v=4211");
  inject('land-4162.js?v=4211"></script>', "/js/spacenet/list-4161.js?v=4211");
  inject('list-4161.js?v=4211"></script>', "/js/spacenet/fill-4199.js?v=4211");
  inject('fill-4199.js?v=4211"></script>', "/js/spacenet/pin-4202.js?v=4211");
  inject('pin-4202.js?v=4211"></script>', "/js/spacenet/pizza-lock-4211.js?v=4211");
  inject('spacenet/app.js?v=4204"></script>', "/js/spacenet/land-4162.js?v=4211");
  return html;
}
