/* SpaceNet SW 4250 - tree lock. Network-first shell. Never inject. Never /boot. Never overlays. */
var CACHE = "sn-shell-4250";
var VER = "4250";
...
self.addEventListener("fetch", function (e) {
  ...
  if (isOverlay(path) || /earth-4204|earth-guest|money-\d|pay-\d|fill-\d|talk-\d|land-\d|pizza-lock|auth-\d/.test(path)) {
    e.respondWith(new Response("/* TREE LOCK 4250: overlay blocked */", {
      status: 200,
