/* SpaceNet SW 4271 — one entity. Tree lock. */
var CACHE = "sn-shell-4271";
var VER = "4271";
var SHELL = ["/", "/index.html", "/js/spacenet/app.js?v=4271", "/js/spacenet/auth.js?v=4271", "/js/vendor/leaflet.js?v=4127", "/js/vendor/leaflet.css?v=4127", "/icon-192.png", "/manifest.webmanifest"];
...
self.addEventListener("fetch", function (e) {
  ...
  if (isOverlay(url.pathname)) {
    e.respondWith(new Response("/* TREE LOCK 4271: overlay blocked */", { headers: { "Content-Type": "application/javascript" }, status: 200 }));
    return;
  }
