# AstranoV · DeepSeek Lab — AI Coder Instructions

## Identity
- **Lab:** DeepSeek Lab
- **Subdomain:** `deepseek.astranov.eu`
- **Repo:** `notisastranov/astranov.eu-deepseek`
...
backend as the main OS. Your work appears at `deepseek.astranov.eu`.
...
5. Vercel auto-deploys to `deepseek.astranov.eu`
