# AstranoV · Gemini (Google) Lab — AI Coder Instructions

## Identity
- **Lab:** Gemini (Google) Lab
- **Subdomain:** `gemini.astranov.eu`
- **Repo:** `notisastranov/astranov.eu-gemini`
...
backend as the main OS. Your work appears at `gemini.astranov.eu`.
...
5. Vercel auto-deploys to `gemini.astranov.eu`
