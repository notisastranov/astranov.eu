# AstranoV · Claude Lab — AI Coder Instructions

## Identity
- **Lab:** Claude Lab (Anthropic)
- **Subdomain:** `claude.astranov.eu`
- **Repo:** `notisastranov/astranov.eu-claude`
...
backend as the main OS. Your work appears at `claude.astranov.eu`.
...
5. Vercel auto-deploys to `claude.astranov.eu`
