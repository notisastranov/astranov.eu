# AstranoV · Grok (xAI) Lab — AI Coder Instructions

## Identity
- **Lab:** Grok (xAI) Lab
- **Subdomain:** `grok.astranov.eu`
- **Repo:** `notisastranov/astranov.eu-grok`
...
backend as the main OS. Your work appears at `grok.astranov.eu`.
...
5. Vercel auto-deploys to `grok.astranov.eu`
